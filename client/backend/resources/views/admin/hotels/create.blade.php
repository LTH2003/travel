...
@section('title', 'Tạo Khách sạn Mới')
@section('page-title', 'Tạo Khách sạn')
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Tạo Khách sạn Mới</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.hotels.store') }}" method="POST">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Tạo Khách sạn
                        </button>

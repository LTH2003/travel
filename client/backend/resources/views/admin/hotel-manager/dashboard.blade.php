    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    <h6 class="card-title">Phòng Còn Trống</h6>
                    <h2 class="mb-0">{{ $stats['available_rooms'] ?? 0 }}</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.hotel-manager.hotels.create') }}" class="btn btn-sm btn-primary">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">Không có khách sạn nào</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
